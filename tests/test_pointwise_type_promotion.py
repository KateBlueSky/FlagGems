...
def test_type_promotion_default(shape, alpha, float_type):
    inp1 = torch.randint(10, shape, device="xpu")
    inp2 = torch.randn(shape, dtype=float_type, device="xpu")
...
def test_type_promotion_int_to_float(shape, float_type):
    # arg0:float
    inp_float = torch.randn(shape, dtype=float_type, device="xpu")
    ...
    # arg0:int
    inp_int = torch.randint(10, shape, device="xpu")
...
def test_type_promotion_always_bool(shape):
    # arg0:int  arg0:int
    inp1 = torch.randint(0, 10, shape, device="xpu")
    inp2 = torch.randint(0, 10, shape, device="xpu")
    ref_inp1 = to_reference(inp1)
    ref_inp2 = to_reference(inp2)
...
def test_type_promotion_complex_to_long(shape, float_type):
    # arg0:float
    inp = torch.randn(shape, dtype=float_type, device="xpu")
...
def test_type_promotion_bool_to_long(shape, float_dtype):
    inp1 = torch.randn(shape, dtype=float_dtype, device="xpu")
    inp2 = torch.randint(0, 10, shape, device="xpu")
    ref_inp1 = to_reference(inp1)
    ref_inp2 = to_reference(inp2)
    # arg0: float  arg1: int
